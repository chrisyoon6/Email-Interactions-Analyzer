...
public class Task4DWTests {
    ...
    public void testMaxedBreachedUserCount3() {
        ...
        Assertions.assertEquals(3, dwig3.MaxBreachedUserCount(0));
        Assertions.assertEquals(3, dwig3.MaxBreachedUserCount(2));
    }

    @Test
    public void testMaxedBreachedUserCount4() {
        Assertions.assertEquals(41, dwig4.MaxBreachedUserCount(25));
    }
}
